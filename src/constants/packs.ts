...
export const STARTER_PACKS: ContentPackManifest[] = [
  ...
  {
    id: 'disaster-winter-weather',
    title: 'Winter Storms & Extreme Cold',
    description:
      'Winter storm, blizzard, freezing rain, and extreme cold safety before, during, and after.',
    category: 'Disasters',
    format: 'html',
    downloadStrategy: 'html_snapshot',
    estimatedSize: 'Web page',
    ...
    sourceLabel: 'Ready.gov',
    fileName: 'ready-winter-weather.html',
    installed: false,
    disclaimer: SAFETY_COPY.disaster,
  },
  {
    ...
    description:
      'Official USDA/FDA chart on refrigerator, freezer, and discarded food after an outage.',
    category: 'Food',
    format: 'html',
    downloadStrategy: 'html_snapshot',
    estimatedSize: 'Web page',
    sourceUrl: 'https://www.foodsafety.gov/food-safety-charts/food-safety-during-power-outage',
    sourceLabel: 'FoodSafety.gov (USDA/FDA)',
    fileName: 'foodsafety-power-outage.html',
    installed: false,
