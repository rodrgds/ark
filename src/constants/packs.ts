...
export const STARTER_PACKS: ContentPackManifest[] = [
  ...
  {
    id: 'voice-qwen3-asr-17b-q8-0',
    title: 'Qwen3 ASR 1.7B Q8_0',
    description:
      'Offline multilingual voice transcription model for turning spoken prompts into Ask Arky text.',
    category: 'AI Models',
    format: 'gguf',
    modelRole: 'voice',
    estimatedSize: '2.02 GB',
    sizeBytes: 2_165_035_040,
    sourceUrl:
      'https://huggingface.co/JamePeng2023/Qwen3-ASR-1.7B-GGUF/resolve/main/Qwen3-ASR-1.7B-Q8_0.gguf',
    sourceLabel: 'Hugging Face: JamePeng / Qwen3 ASR',
    fileName: 'Qwen3-ASR-1.7B-Q8_0.gguf',
    installed: false,
    disclaimer: SAFETY_COPY.ai,
  },
  {
    id: 'voice-qwen3-asr-17b-mmproj-bf16',
    title: 'Qwen3 ASR Audio Projector BF16',
    description: 'Required audio projector for Qwen3 ASR voice transcription.',
    category: 'AI Models',
    format: 'gguf',
    modelRole: 'voiceProjector',
    estimatedSize: '612 MB',
    sizeBytes: 641_774_112,
    sourceUrl:
      'https://huggingface.co/JamePeng2023/Qwen3-ASR-1.7B-GGUF/resolve/main/mmproj-Qwen3-ASR-1.7b-BF16.gguf',
    sourceLabel: 'Hugging Face: JamePeng / Qwen3 ASR',
    fileName: 'mmproj-Qwen3-ASR-1.7b-BF16.gguf',
    installed: false,
    disclaimer: SAFETY_COPY.ai,
  },
