...
export const ARK_TABS: ArkTabDefinition[] = [
  {
    ...
    routeName: 'chat',
    label: 'Arky',
    description: 'Local AI chat with answers grounded in your sources.',
    locked: true,
    sfSymbol: {
  ...
  },
  {
    ...
    routeName: 'tracks',
    label: 'Tracks',
    description: 'Record movement, photos, markers, and charts, then export tracks as GPX.',
  ...
  },
  {
    ...
    routeName: 'notes',
    label: 'Notes',
    description: 'Passphrase-protected secure notes.',
  ...
  },
  {
    ...
    routeName: 'settings',
    label: 'Settings',
    description: 'Vault, downloads, field options, and app controls.',
    locked: true,
